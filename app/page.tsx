...
export default function Home(){
  ...
  return <main><AsciiLogo/>
    ...
    {view==="projects"&&<>
      <section className="hero"><h1><span>DI ZHENG PORTFOLIO</span><span>VISUAL DESIGNER</span><span className="hero-year"><img className="hero-silver-logo" src="/silver-logo-transparent.png" alt="DI Zheng silver logo"/><em>2026</em></span></h1></section>
