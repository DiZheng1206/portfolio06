...
export default function Home(){
  ...
  return <main><AsciiLogo/>
    ...
    {view==="projects"&&<>
      <section className="hero"><h1><span>Di zheng portfolio,</span><span>Visual Designer</span><span>2026</span></h1><a className="scroll-cue" href="#projects"><span>scroll down</span><b>↓</b></a></section>
